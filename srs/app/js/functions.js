...
function addElement(listDOMId, msg_id, author_name, author_id, text,token_array_id,token_array, post_time) {
    ...
    var msg_txt = text;
    link2.setAttribute("href", "javascript:share_msg(\""+text+"\")");
...
{
    console.log(name+",");
    var reply = document.getElementById("demo-input-facebook-theme");
    reply.innerHTML = name+",";
    window.scroll(0,0);
    
    
//        $("#demo-input-facebook-theme").click(function () {
...
{
    alert("Share will allow you to re-share this message to other groups.")
   
}

 function reply_sample()
{
    alert("Reply will allow you to reply to the group the message originated from.")
    
}

 function delete_sample()
{
    alert("Delete will delete the message from your message stream.");
    
}
 function group_sample()
 {
     alert("Clicking on the certain group will re-direct you to the messages within that particular group.")
 }
...
{   
      ...
      window.location= "index.php?token_id="+token_id;
}
