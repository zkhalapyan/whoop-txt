...
<html>
	...
	<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js"></script> 
        ...
        <link rel="stylesheet" href="../javascript/css/app_styles.css" type="text/css" />   
        <link rel="stylesheet" href="../javascript/css/fb_styles.css" type="text/css" />    
...
<script language="javascript" type="text/javascript" src="../javascript/js/actb.js"></script>
<script language="javascript" type="text/javascript" src="../javascript/js/common.js"></script>
<script>
    ...
    <body>
        <?PHP include("../javascript/app_header.php"); ?>
        <div id="bodyContent">
       ...
       <script>
        ...
        <?PHP include("../javascript/app_footer.php"); ?>
    </body>
